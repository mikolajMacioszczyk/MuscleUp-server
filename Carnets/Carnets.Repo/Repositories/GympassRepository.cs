...
namespace Carnets.Repo.Repositories
{
    public class GympassRepository : IGympassRepository
    {
        ...
        {
            var interestedGympassTypesIds = (await _gympassTypeRepository
                .GetAllGympassTypes(fitnessClubId, false, 0, int.MaxValue, asTracking, orderBy: g => g.GympassTypeName))
